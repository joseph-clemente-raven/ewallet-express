...
const Dashboard = () => {
  ...
  return (
    <div className='flex flex-col w-full min-h-screen gap-4 bg-white'>
      <div className='flex justify-between pt-6 px-6'>
        <div>
          <p className='text-gray-700'>Good morning,</p>
          <p className='font-extrabold text-xl text-primary'>Juan Dela Cruz</p>
        </div>
        <div>
          <Image src={`${imgSetup}user.png`} width={50} height={50} alt='user' />
        </div>
      </div>
      <div className='rounded-lg bg-primary/70 flex flex-col mx-6 shadow-xl'>
        ...
        <div className='rounded-lg w-full flex justify-between bg-gradient-to-b from-primary to-primary/50 py-4 px-6'>
          ...
          <Link href={'/scanner'} className='flex flex-col justify-center items-center gap-1'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#fff" class="size-6">
